    ...
    <>
            ...
            <div className="mb-16 relative z-10" style={{ opacity: 0, animation: 'pageFadeIn 0.8s ease 0.6s forwards' }}>
              <div className="flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-[13px] text-industrial-smoke opacity-60 font-body">
                  Free to apply · 10 min form · Cohort starts June 7th
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-8">
            <StaggerCard className="bg-industrial-obsidian border border-industrial-zinc p-8">
              <div className="flex items-center gap-3 mb-6 relative z-20"><CheckCircle2 className="h-6 w-6 text-industrial-orange" /><h3 className="font-heading text-xl text-white">IDEAL PARTICIPANTS</h3></div>
            ...
            <StaggerCard className="bg-industrial-obsidian border border-red-900/30 p-8">
              <div className="flex items-center gap-3 mb-6 relative z-20"><XCircle className="h-6 w-6 text-red-500" /><h3 className="font-heading text-xl text-white">NOT FOR</h3></div>
      ...
      <section className="py-24 bg-industrial-obsidian">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {promises.map((p, i) => <StaggerCard key={i} className="bg-industrial-steel/50 border border-industrial-zinc p-6 card-hover"><p.icon className="h-8 w-8 text-industrial-orange mb-4 relative z-20" /><h3 className="font-heading text-lg text-white mb-2 relative z-20">{p.title}</h3><p className="font-body text-sm text-industrial-smoke relative z-20">{p.desc}</p></StaggerCard>)}
          </StaggerContainer>
          ...
          <StaggerContainer className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <RevealSection>
                ...
                <ul className="space-y-2">{visits.map((v, i) => <li key={i} className="flex items-center gap-3 font-body text-industrial-smoke"><Factory className="h-4 w-4 text-industrial-orange" />{v}</li>)}</ul>
              </RevealSection>
            </div>
          </StaggerContainer>
        </div>
          ...
          <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[{ v: "9", l: "Days", icon: Clock }, { v: "15", l: "Max Participants", icon: Users }, { v: "Coimbatore", l: "Location", icon: MapPin }, { v: "Lifetime", l: "Post-program Access", icon: Factory }].map((d, i) => (
              <StaggerCard key={i} className="bg-industrial-obsidian border border-industrial-zinc p-6 text-center">
                <d.icon className="h-6 w-6 text-industrial-orange mx-auto mb-4 relative z-20" />
            ...
            <StaggerCard className="bg-industrial-steel border border-industrial-zinc p-10 flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-5xl sm:text-6xl font-serif text-industrial-linen font-bold leading-none">On Request</span>
                </div>
              ...
              <div className="pt-6 border-t border-industrial-zinc/30">
                ...
                <p className="text-industrial-orange text-xs mt-4 font-bold">Fee disclosed during screening call.</p>
              </div>
            </StaggerCard>
        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <RevealSection className="mb-16">
            <p className="text-4xl sm:text-5xl font-serif text-industrial-linen font-light max-w-3xl mx-auto leading-tight">
              "That's exactly the point of June 7th."
            </p>
          </RevealSection>
          ...
          <RevealSection className="mb-20">
            <div className="relative inline-block px-12 py-10 border border-industrial-zinc/30 bg-industrial-steel/20 backdrop-blur-sm">
               <Quote className="absolute -top-4 -left-4 h-12 w-12 text-industrial-orange opacity-20" />
      ...
      <section className="py-24 bg-industrial-steel">
        <div className="max-w-7xl mx-auto px-4">
          <StaggerContainer className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <RevealSection className="flex items-center gap-3 mb-4"><GraduationCap className="h-6 w-6 text-industrial-orange" /><p className="label-text">Academic Access</p></RevealSection>
      ...
      <section className="py-24 bg-industrial-obsidian">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <RevealSection className="mt-8">
            <Link to="/about"><Button variant="outline" className="border-industrial-orange text-industrial-orange hover:bg-industrial-orange hover:text-white rounded-none">Learn More<ChevronRight className="ml-2 h-4 w-4" /></Button></Link>
          </RevealSection>
        </div>
      </section>
      ...
      <section className="py-24 bg-industrial-steel">
        <div className="max-w-3xl mx-auto px-4">
          <RevealSection className="flex items-center justify-center gap-3 mb-4"><HelpCircle className="h-6 w-6 text-industrial-orange" /><p className="label-text">Frequently Asked</p></RevealSection>
      ...
      <section className="py-24 bg-industrial-obsidian">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <RevealSection className="text-center">
            ...
            <p className="text-industrial-smoke font-body text-sm mt-6 opacity-60 italic">Applications close April 30th, 2026</p>
          </RevealSection>
        </div>
      </section>

      {/* Ready to apply? (Fix 3) */}
      <section className="py-[60px] bg-white/[0.03] border-t border-b border-[#D4A017]/15">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <RevealSection className="mb-12">
            <p className="font-body text-industrial-linen text-lg">
              15 seats. Cohort starts June 7th. <br />
              <span className="text-white font-bold">Applications close April 30th, 2026.</span>
            </p>
          </RevealSection>
