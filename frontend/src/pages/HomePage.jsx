      ...
      <section data-testid="hero-section" className="relative min-h-screen flex items-end pb-20 lg:pb-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-4xl">
            ...
            <motion.div variants={fadeUp} className="mt-8 p-4 bg-industrial-steel/50 border border-industrial-zinc">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <CountdownTimer targetDate={COHORT_START} label="Cohort Starts June 7th" />
                <div className="text-center">
                  <div className="flex items-center justify-center gap-2 text-red-500 mb-2"><AlertCircle className="h-4 w-4" /><span className="label-text text-red-500">Applications Close</span></div>
      ...
      <section className="py-24 bg-industrial-obsidian">
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection>
            ...
            <motion.p variants={fadeUp} className="font-body text-industrial-smoke text-center mb-16">This is not exposure. <span className="text-industrial-orange font-bold">This is independence.</span></motion.p>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[{ v: "9", l: "Days", icon: Clock }, { v: "15", l: "Max Participants", icon: Users }, { v: "Coimbatore", l: "Location", icon: MapPin }, { v: "∞", l: "Post-program Access", icon: Factory }].map((d, i) => (
                <motion.div key={i} variants={fadeUp} className="bg-industrial-obsidian border border-industrial-zinc p-6 text-center">
                  <d.icon className="h-6 w-6 text-industrial-orange mx-auto mb-4" /><div className="stat-number mb-2">{d.v}</div><p className="label-text">{d.l}</p>
                </motion.div>
              ))}
            </div>
          </AnimatedSection>
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          <AnimatedSection>
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap justify-center gap-8 mt-12 pt-8 border-t border-industrial-zinc">
              {[{ v: "15", l: "People" }, { v: "9", l: "Days" }, { v: "June 7", l: "Start" }].map((s, i) => <div key={i} className="text-center"><p className="stat-number text-2xl">{s.v}</p><p className="label-text">{s.l}</p></div>)}
            </motion.div>
          </AnimatedSection>
        </div>
      </section>
