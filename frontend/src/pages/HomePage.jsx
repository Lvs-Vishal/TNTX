        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 w-full border-t border-industrial-zinc/50 pt-8 backdrop-blur-sm bg-black/20 p-8 rounded-lg mt-16">
            <div className="flex-1 w-full md:w-auto">
              <CountdownTimer targetDate={COHORT_START} label="COHORT STARTS JAN 5TH" />
            </div>
            ...
            <div className="flex-1 text-center w-full md:w-auto">
              ...
              <p className="font-heading text-white text-3xl sm:text-4xl tracking-tight">October 23rd, 2027</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="w-full">
                ...
                <div className="mt-6 space-y-2 text-center">
                  <p className="text-white font-body text-xs opacity-90 font-bold">
                    Applications close October 23rd, 2027.
                  </p>
      ...
      <section className="py-24 bg-industrial-obsidian">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <RevealSection className="text-center">
            ...
            <p className="text-industrial-smoke font-body text-sm mt-6 opacity-60 italic">Applications close October 23rd, 2027</p>
          </RevealSection>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <RevealSection className="mb-12">
            <p className="font-body text-industrial-linen text-lg">
              ...
              <span className="text-white font-bold">Applications close October 23rd, 2027.</span>
            </p>
          </RevealSection>
